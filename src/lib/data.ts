...
export const formatFormName = (formKey: string): string => {
  ...
  if (formKey === 'form_9') return 'Form 09 - Request for Publication'; // Added for compatibility
  if (formKey === 'form_9a') return 'Form 09A - Additional Document'; // Added for compatibility
