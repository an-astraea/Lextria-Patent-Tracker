...
const PatentList: React.FC<PatentListProps> = ({ patents, onExportToExcel }) => {
  ...
  const handleDetailedExport = () => {
    ...
    const exportData = patents.map(patent => ({
      ...
      // Forms Information (using the correct property names from database)
      'Form 1': patent.form_01 ? 'Yes' : 'No',
      'Form 2 PS': patent.form_02_ps ? 'Yes' : 'No',
      'Form 2 CS': patent.form_02_cs ? 'Yes' : 'No',
      'Form 3': patent.form_03 ? 'Yes' : 'No',
      'Form 4': patent.form_04 ? 'Yes' : 'No',
      'Form 5': patent.form_05 ? 'Yes' : 'No',
      'Form 6': patent.form_06 ? 'Yes' : 'No',
      'Form 7': patent.form_07 ? 'Yes' : 'No',
      'Form 7A': patent.form_07a ? 'Yes' : 'No',
      'Form 8': patent.form_08 ? 'Yes' : 'No',
      'Form 8A': patent.form_08a ? 'Yes' : 'No',
      'Form 9': patent.form_09 ? 'Yes' : 'No',
      'Form 9A': patent.form_09a ? 'Yes' : 'No',
